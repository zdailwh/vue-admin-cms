...
export const constantRoutes = [
  ...
  {
    path: '/contentprocesses',
    component: Layout,
    children: [
      {
        path: 'list',
        name: 'Contentprocesses',
        component: () => import('@/views/table/contentprocesses'),
        meta: { title: '转码处理', icon: 'table' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'list',
        name: 'Recontents',
        component: () => import('@/views/table/recontents'),
        meta: { title: '已转码内容', icon: 'table' }
      }
    ]
  },
  {
  ...
  //       path: 'issuePlan',
  //       name: 'IssuePlan',
  //       component: () => import('@/views/table/issuePlan'),
  //       meta: { title: '发布进度', icon: 'table' }
  //     },
  //     {
  //       path: 'issued',
  //       name: 'Issued',
  //       component: () => import('@/views/table/issued'),
  //       meta: { title: '已发布视频', icon: 'table' }
  //     }
  //   ]
  // },
